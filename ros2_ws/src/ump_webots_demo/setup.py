...
setup(
    ...
    description="Webots visual warehouse demonstration for UMP",
    license="Apache-2.0",
    entry_points={"console_scripts": [
        "warehouse_smoke_client = ump_webots_demo.warehouse_smoke_client:main",
    ]},
)
