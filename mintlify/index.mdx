...
<Tabs>
  ...
  <Tab title="Fleet Integrator">
    Generate a [local awareness network](/guides/deployment), configure mutual-TLS identities, and connect standards integrations. Use the coordinator to submit shared goals while enforcing authority leases and disclosure policy.
  </Tab>
</Tabs>
